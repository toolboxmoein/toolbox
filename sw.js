...
const CACHE_NAME = 'my-app-cache-v14'; // نام کش به v14 افزایش یافت (برای اطمینان از به‌روزرسانی فوری)
...
self.addEventListener('fetch', (event) => {
    ...
    // --- استراتژی NetworkFirst برای درخواست‌های API به Cloudflare Worker ---
    // این تضمین می‌کند که داده‌های داینامیک (مانند پیام‌ها) همیشه ابتدا از شبکه گرفته می‌شوند.
        ...
        event.respondWith(
            fetch(event.request)
                ...
                .catch(() => {
                    ...
                    console.log('Service Worker: Network failed for API request, trying cache:', event.request.url);
